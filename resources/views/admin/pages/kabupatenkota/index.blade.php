              ...
              <tbody>
                @if(count($regencyCities) <= 0) <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{route('kabkota.edit', $row['id'])}}" class="btn btn-warning btn-sm">Edit</a>
                      <a href="{{route('kabkota.show', $row['id'])}}" class="btn btn-info btn-sm">View</a>

    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
          <div class="peta_sebaran"><img src="assets/img/portfolio/portfolio-1.jpg" class="img-fluid" alt=""></div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-web">
          <div class="peta_sebaran"><img src="assets/img/portfolio/portfolio-2.jpg" class="img-fluid" alt=""></div>
          <div class="portfolio-info">
            <h4>Web 3</h4>
            <p>Web</p>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
          <div class="peta_sebaran"><img src="assets/img/portfolio/portfolio-3.jpg" class="img-fluid" alt=""></div>
          <div class="portfolio-info">
            <h4>App 2</h4>
            <p>App</p>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
          <div class="peta_sebaran"><img src="assets/img/portfolio/portfolio-4.jpg" class="img-fluid" alt=""></div>
          <div class="portfolio-info">
            <h4>Card 2</h4>
            <p>Card</p>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-web">
          <div class="peta_sebaran"><img src="assets/img/portfolio/portfolio-5.jpg" class="img-fluid" alt=""></div>
          <div class="portfolio-info">
            <h4>Web 2</h4>
            <p>Web</p>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
          <div class="peta_sebaran"><img src="assets/img/portfolio/portfolio-6.jpg" class="img-fluid" alt=""></div>
          <div class="portfolio-info">
            <h4>App 3</h4>
            <p>App</p>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
          <div class="peta_sebaran"><img src="assets/img/portfolio/portfolio-7.jpg" class="img-fluid" alt=""></div>
          <div class="portfolio-info">
            <h4>Card 1</h4>
            <p>Card</p>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
          <div class="peta_sebaran"><img src="assets/img/portfolio/portfolio-8.jpg" class="img-fluid" alt=""></div>
          <div class="portfolio-info">
            <h4>Card 3</h4>
            <p>Card</p>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-web">
          <div class="peta_sebaran"><img src="assets/img/portfolio/portfolio-9.jpg" class="img-fluid" alt=""></div>
          <div class="portfolio-info">
            <h4>Web 3</h4>
            <p>Web</p>
